...
public:
	...
	bool Initialize(ID3D11Device* device, ID3D11DeviceContext* deviceContext, HWND hwnd, float posX, float posY, char* animationsFile, char* basisShaderFileName, XMFLOAT2 uvs[4],
