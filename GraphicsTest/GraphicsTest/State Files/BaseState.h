...
{
public:
	enum STATE_ACTIONS { NO_ACTION, SHUTDOWN_STATE, FULL_SHUTDOWN, MOVE_TO_MENU, MOVE_TO_GAMEPLAY, MOVE_TO_OPTIONS, MOVE_TO_PAUSE, MOVE_TO_SAVE, MOVE_TO_LOAD, NUM_ACTIONS };
	enum STATES { ENTRY_STATE, MENU_STATE, OPTIONS_STATE, CREDITS_STATE, GAMEPLAY_STATE, PAUSE_STATE, NUM_STATES};
